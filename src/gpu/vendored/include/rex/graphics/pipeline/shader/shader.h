...
class Shader {
 public:
  ...
  // Translations retain a reference to their owning Shader. Neither their raw
  // ownership nor an owner-local borrowed lookup may be copied or relocated.
 ...
 private:
  // Map rehash preserves Translation allocations. Every deletion invalidates
  // this entry first, independent of the diagnostic lookup switch.
  nb::gpu::NativeTranslationLookupMemo<Translation> translation_lookup_memo_;
